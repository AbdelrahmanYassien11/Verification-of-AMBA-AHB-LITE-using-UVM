...
class READ_WRAP8_sequence extends base_sequence;
  ...
  virtual task body();
    ...
    start_item(seq_item); // Start the sequence item
      ...
      assert(seq_item.randomize() with {RESET_op == WORKING; WRITE_op == READ; TRANS_op == NONSEQ; BURST_op == WRAP8;});
    ...
    for (int i = 0; i < 7; i++) begin
      ...
      // Set the operation type to READ
      // Randomize the sequence item
      assert(seq_item.randomize() with {RESET_op == WORKING; WRITE_op == READ; TRANS_op == SEQ; BURST_op == WRAP8;});
