...
class WRITE_WRAP8_sequence extends base_sequence;
  ...
  virtual task body();
    ...
    start_item(seq_item); // Start the sequence item
      ...
      assert(seq_item.randomize() with {seq_item.RESET_op == WORKING; seq_item.WRITE_op == WRITE; seq_item.TRANS_op == NONSEQ; seq_item.BURST_op == WRAP8;}); // Randomize the sequence item
    ...
    for (int i = 0; i < 7; i++) begin
      ...
      start_item(seq_item); // Start the sequence item
        ...
        assert(seq_item.randomize() with {seq_item.RESET_op == WORKING; seq_item.WRITE_op == WRITE; seq_item.TRANS_op == SEQ; seq_item.BURST_op == WRAP8;}); // Randomize the sequence item
